<script src="../js/adminviewappointments.js"></script>
<link rel="stylesheet" href="../css/adminviewappointments.css"/>
...
<div class="viewappointments_body">
    ...
    <div id="Today" class="viewappointments_tabcontent box_shadow" style="display:block;">
            Today
    </div>

    <div id="Upcoming" class="viewappointments_tabcontent box_shadow">
        Upcoming
    </div>

    <div id="Status" class="viewappointments_tabcontent box_shadow">
    ...
    <div id="SearchAppointment" class="viewappointments_tabcontent box_shadow">
       <form id="appointment_search_form" autocomplete="on" method="post">
           <input id="appointment_search_value" class="searchbar" type="search" placeholder="Search by Id, Patient Id, Reason or Date(y-m-d)" focus/>
    ...
    <div id="SetAppointment" class="viewappointments_tabcontent box_shadow">
       <form autocomplete="on" id="set_appointment_form" method="post">
            ...
            <label class="set_appointment_label" for="reason">Patient Id:</label><br/>
           <input type="text" class="set_appointment_input" id="id_input" maxlength=7 placeholder="Patients Matric/Staff Number" required><br/><br/>
