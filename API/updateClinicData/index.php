<?php
 ...
 header("Access-Control-Allow-Headers: Content-Type, Access-Control-Allow-Headers, Authorization, X-Requested-With");
    ...
    if(isset($_GET) && isset($_GET["matricNo"])){
        ...
        $query= "UPDATE clinicdata SET bloodGroup='$bloodgroup', genotype='$genotype', pmc='$pmc', height='$height', `weight`='$weight', BMI='$bmi', allergies='$allergies', surgeries='$surgeries', lastModified='$lastModified', modifiedBy='$matricNo' WHERE matricNo='$patientId';";
