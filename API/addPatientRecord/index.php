<?php
 ...
 header("Access-Control-Allow-Headers: Content-Type, Access-Control-Allow-Headers, Authorization, X-Requested-With");
    ...
    if(isset($_GET) && isset($_GET["matricNo"])){
        ...
        $query= "INSERT INTO `patientrecord` (appointmentId,patientId,notes,diagnosis,creatorId,dateCreated,timeCreated) VALUES ('$appointmentId','$patientId','$notes','$diagnosis','$matricNo','$dateCreated','$timeCreated');";
